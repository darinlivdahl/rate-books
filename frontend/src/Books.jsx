...
function Books(props) {
    ...
    const { list, listheading, onBookShowDetail } = props;
    ...
    return (
        <>
            <h2 class="font-serif text-1xl md:text-2xl font-semibold mb-4 md:mb-6 lg:mb-12">Best Sellers List - {listheading}</h2> 
